...
void main() {
  test(
    'create schema v1 in memory and check tables and foreign_keys pragma',
    () async {
      // Init ffi
      sqfliteFfiInit();
      ...
      try {
        ...
        final idx = await db.rawQuery(
          "SELECT name FROM sqlite_master WHERE type='index' AND name='idx_movements_account_date';",
        );
