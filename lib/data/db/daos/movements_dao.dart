...
Future<int> insertMovementRow(DatabaseExecutor db, Map<String, Object?> row) async {
...
Future<int> updateMovementRow(DatabaseExecutor db, String id, Map<String, Object?> row) async {
